...
const Footer = () => {
    return (
      ...
      <footer className="  bg-gray-900 w-full z dark:bg-neutral-950 hero md:min-h-96  " style={{backgroundImage: 'url(https://i.ibb.co/s2sz9tr/crop-plate-with-vegetable-salad.jpg)',backgroundSize:'100% 100%',backgroundRepeat: 'no-repeat'}} >
        <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
          ...
          <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400 dark:text-neutral-400">© 2024 FoodDonation. All rights reserved.</p>
            </div>
