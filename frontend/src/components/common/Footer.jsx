...
const Footer = () => {
    return (
      ...
      <footer className="  bg-[#353535] w-ful   "  >
        <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-10 mx-auto">
            ...
            <div className="col-span-2">
              ...
              <form>
                <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                  ...
                  <a className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#ABD700] text-black  disabled:opacity-50 disabled:pointer-events-none" href="#">
                    Subscribe
                  </a>
                </div>
          ...
          <div className="mt-4 sm:mt-8 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400 dark:text-neutral-400">Created with ❤️ © 2024 FoodDonation. All rights reserved.</p>
            </div>
